...
public class Agencia {
	...
	public void nuevo_inmueble() {
		...
		case 2:
			...
			case 2:
				...
				System.out.println("El inmueble se ha añadido correctamente.");
			}
		}
	}
				...
				case 7:
					...
					do {
						...
						if(select == 1) {
							...
							System.out.println("Seleccine una opcion válida.");
						}
					} while (exit != true);
					exit = false;
					break;
	...
	public void rangoTamaño() {
		...
		for (int i = 0; i < inmuebles.size(); i++) {
			if (inmuebles.get(i).getM2() >= tamaño_minimo && inmuebles.get(i).getM2() <= tamaño_maximo) {
				System.out.println(inmuebles.get(i).toString());
			}
		}
	}
